...
const Skills = () => {
  ...
  }, [inView, animationHeader, animationProject1, animationProject2, animationProject3, animationArrow]);
    ...
    <div ref = {ref} className="app__skills-container" id='skills'>
      ...
      <div className ="app__skills__container">
        ...
        animate= {animationArrow}>
          <a href="#contact" class="skills-arrow-container" alt="Go to contact section">
            <div class="arrow"></div>
            <div class="arrow"></div>
            <div class="arrow"></div>  
          </a>
